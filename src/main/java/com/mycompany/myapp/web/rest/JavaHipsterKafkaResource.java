...
@RestController
@RequestMapping("/api/java-hipster-kafka")
public class JavaHipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JavaHipsterKafkaResource.class);
    ...
    public JavaHipsterKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
